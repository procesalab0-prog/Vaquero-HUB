...
-- Impide que un código externo ocupe el rango 20-29 reservado al generador
-- interno. Se reemplaza la función completa para que la corrección alcance
-- también a las bases donde la versión anterior ya fue aplicada.
