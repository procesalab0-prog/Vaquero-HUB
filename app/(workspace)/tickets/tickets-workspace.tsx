  ...
  return (
    <section className="module-page tickets-page">
      ...
      <div className="demo-data-notice">
        ...
        <span>
          <strong>Pantalla de demostración</strong> Los cuatro tickets de abajo
          son de ejemplo, no ventas reales. Todavía no consulta la base: para
          reimprimir una venta de verdad, hazlo desde el punto de venta al
          momento de cobrar.
        </span>
      </div>
