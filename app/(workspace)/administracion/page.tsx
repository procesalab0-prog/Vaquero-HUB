...
const statusMessages: Record<string, string> = {
  ...
  "empleado-configuracion-error":
    "La creación de accesos no está configurada en este ambiente.",
  "empleado-datos-invalidos":
    "Revisa los datos: todos son obligatorios y la contraseña debe tener al menos 12 caracteres.",
  "empleado-relacion-invalida":
    "El rol o la sucursal seleccionados ya no están disponibles.",
  ...
  "empleado-acceso-error":
    "Supabase no pudo crear el acceso del empleado. Inténtalo nuevamente.",
  ...
  "sucursal-codigo-invalido":
    "El código operativo admite de 2 a 10 letras o números, sin espacios ni signos.",
      ...
      <div className="section-heading">
        <div>
          ...
          <p className="heading-copy">
            Administra quién puede hacer qué y conserva evidencia de los
            cambios.
          </p>
        </div>
  ...
  return (
    <section className="module-page admin-page">
      ...
      <div className="admin-status">
        La interfaz está lista. Los datos reales aparecerán al conectar esta
        publicación con la base de staging.
      </div>
      <nav className="admin-tabs" aria-label="Administración">
        {tabs.map(({ id, label, icon: Icon }) => (
          <Link
      ...
      <div className="admin-panel">
        <div className="admin-empty">
          <ShieldCheck aria-hidden="true" />
          <strong>Producción sigue protegida</strong>
          <span>
            Esta vista pública no usa datos reales. La prueba de empleados y
            sucursales se hará contra staging.
          </span>
        </div>
      </div>
    </section>
      ...
      <details className="admin-create" open={employees.length === 0}>
        ...
        {canCreate ? (
          ...
          <div className="admin-inline-warning">
            ...
            <span>
              Podrás consultar y editar empleados; crear accesos se habilita al
    ...
    <div className="admin-panel">
      <div className="admin-panel-heading">
        <div>
          ...
          <p>
            El inventario, empleados y reportes quedarán separados por
            ubicación.
          </p>
        </div>
      </div>
        ...
        {locations.map((location) => (
          <details className="location-card" key={location.id}>
            ...
            {location.type === "TRANSIT" ? (
              <div className="admin-inline-warning">
                <strong>Ubicación protegida del sistema</strong>
                <span>
  ...
  return (
    <div className="admin-panel">
      ...
      <p className="admin-footnote">
        La edición masiva se habilitará con una operación atómica para evitar
    ...
    <div className="admin-panel">
      <div className="admin-panel-heading">
        <div>
          <h2>Bitácora</h2>
          <p>
            Últimos {rows.length} eventos. Estos registros no se pueden editar
            ni borrar.
          </p>
        </div>
      </div>
      ...
      {rows.length === 0 ? (
        <div className="admin-empty">
          <ClipboardList aria-hidden="true" />
          <strong>Aún no hay eventos visibles</strong>
          <span>Los cambios administrativos aparecerán aquí.</span>
        </div>
      ) : null}
    </div>
  );
