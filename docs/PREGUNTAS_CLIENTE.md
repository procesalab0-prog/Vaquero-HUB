...
| 3.5 | Envío automático por SMS, WhatsApp o correo: ¿qué proveedor prefieren, y es obligatorio en toda venta o sólo cuando el cliente lo pide? PDF local e historial privado no requieren proveedor. | M8      | ⚪       |
