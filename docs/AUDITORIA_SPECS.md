...
## 🔴 A-1. El `revoke` sobre el esquema `app` va a romper todas las políticas de RLS
...
tal como está, obtendría el error.

---

## 🔴 A-2. El bloqueo por intentos de PIN nunca va a incrementar
...
exista y pase es la verificación.

---

## 🔴 A-3. `apply_movement` recibe el usuario como parámetro y no valida la ubicación
...
## 🟠 A-4. `movement_type` no está restringido: un typo entra sin ruido
...
## 🟠 A-5. Nada obliga a que el movimiento cuadre consigo mismo
...
## 🟠 A-6. Los valores de atributo se pueden duplicar por culpa de los nulos
...
## 🟠 A-7. El código de barras heredado vive en dos lugares a la vez
...
## 🟠 A-8. Dos documentos describen el descuento atómico con fórmulas distintas
...
## 🟡 A-9. Huecos que Codex tendría que adivinar
