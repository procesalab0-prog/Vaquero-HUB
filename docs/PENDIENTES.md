...
| M3 inventario | 1 | Especificado, sin implementar |
...
Cuatro de once pantallas están conectadas a la base: Productos, Clientes,
Administración y Etiquetas. POS, Caja, Inventario, Tickets, Ajustes, Inicio y
